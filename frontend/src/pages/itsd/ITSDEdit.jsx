      ...
      <div className="row justify-content-center g-4">
        ...
        <div className="col-12 col-md-4">
          <div className="card shadow-sm p-4 h-100">
            <h4 className="text-center text-primary mb-4">Profile Info</h4>
        ...
        <div className="col-12 col-md-4">
          <div className="card shadow-sm p-4 h-100">
            ...
            <button className="btn btn-primary w-100 mt-3" onClick={handleSubmit}>Save Changes</button>
          </div>
        </div>
      </div>
    </div>
...
const FormField = ({ label, name, value, onChange, type = "text" }) => (
  <div className="mb-3">
    <label className="form-label text-primary fw-bold">{label}</label>
    <input
      type={type}
