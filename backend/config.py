...
# Load .env.development first (for local development overrides)
...
class Config:
    ...
    # JWT Configuration
    JWT_SECRET_KEY = get_secret('JWT_SECRET_KEY', 'jwt-secret-key')
    ...
    ADMIN_INIT_PASSWORD = get_secret('ADMIN_INIT_PASSWORD', None)
